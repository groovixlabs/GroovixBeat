...
public:
    ...
    void initialise (const String& commandLine) override
    {
        ...
        auto logoImage = juce::ImageCache::getFromMemory (BinaryData::GroovixLabsSplash_png,
                                                          BinaryData::GroovixLabsSplash_pngSize);

        if (logoImage.isValid())
        {
            auto* splash = new juce::SplashScreen ("GrooviXBeat", logoImage, true);
            splash->deleteAfterDelay (juce::RelativeTime::seconds (4), true);
        }
    ...
    void handleAsyncUpdate() override
    {
        ...
        // This loads the last saved filtergraph.
        /*
        if (! fileToOpen.existsAsFile())
        {
