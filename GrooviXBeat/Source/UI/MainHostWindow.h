...
namespace CommandIDs
{
    ...
    static const int showGraph              = 0x30700;
    static const int toggleMidiKeyboard     = 0x30800;
    static const int pingSequencer          = 0x30900;
    static const int saveSequencerState     = 0x30A00;
    static const int loadSequencerState     = 0x30B00;
    static const int newProject             = 0x30C00;
    static const int openProject            = 0x30D00;
    static const int showSettings           = 0x30E00;
}
